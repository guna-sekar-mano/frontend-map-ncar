...
require([
  ...
  const layer = new GeoJSONLayer({
    url: "https://demo-tcz.s3.ap-south-1.amazonaws.com/sample.json",
    ...
    const simpleMarkerSymbol = {
      ...
      function showAddress(address, pt) {
       ...
       let url = "http://localhost:3000/getjson";
    ...
    function opengraph(address,long,lat){
      ...
      var icon='<i class="fa-solid fa-location-dot"></i> ';
      $('#exampleModalLabel').html(icon + address)
